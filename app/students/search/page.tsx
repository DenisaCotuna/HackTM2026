...
const SSearch: React.FC = () => {
  const fallbackPhoto =
    'data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="320" height="210"><rect width="100%" height="100%" fill="%23dee2e6"/><text x="50%" y="50%" fill="%23666" font-family="Arial, sans-serif" font-size="24" text-anchor="middle" dominant-baseline="middle">No Image</text></svg>';
  const [minBudget, setMinBudget] = useState<string>('');
  const [maxBudget, setMaxBudget] = useState<string>('');
  const [areaZone, setAreaZone] = useState<string>('');
          ...
          <div className="d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
              ...
              <p className="text-muted mb-0">
                Find the best student housing offers with filters and sorting.
              </p>
            </div>
            ...
            <Card.Body>
              ...
              <Form>
                  ...
                  <Col xs={6}>
                    <Form.Group className="mb-3" controlId="minBudget">
                      ...
                      <Form.Control
                        ...
                        min="0"
                        value={minBudget}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMinBudget(e.target.value)}
                        placeholder="Min"
                      />
                    </Form.Group>
                  </Col>
                  <Col xs={6}>
                    <Form.Group className="mb-3" controlId="maxBudget">
                      ...
                      <Form.Control
                        ...
                        min="0"
                        value={maxBudget}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMaxBudget(e.target.value)}
                        placeholder="Max"
                      />
                    </Form.Group>
                  </Col>
                ...
                <Form.Group className="mb-3" controlId="areaZone">
                  ...
                  <Form.Select
                    value={areaZone}
                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setAreaZone(e.target.value)}
                  >
                ...
                <Form.Group className="mb-3" controlId="availableFrom">
                  ...
                  <Form.Control
                    type="date"
                    value={availableFrom}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAvailableFrom(e.target.value)}
                  />
                </Form.Group>
                ...
                <Form.Group className="mb-2" controlId="furnishedOnly">
                  <Form.Check
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFurnishedOnly(e.target.checked)}
                  />
                </Form.Group>
                <Form.Group className="mb-3" controlId="utilitiesIncluded">
                  <Form.Check
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setUtilitiesIncluded(e.target.checked)}
                  />
                </Form.Group>

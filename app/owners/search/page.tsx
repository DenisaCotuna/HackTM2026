...
export default function OSearch() {
      ...
      <Row>
        <Col xs={12} className="mb-4">
          <div className="d-flex flex-wrap justify-content-between align-items-center gap-3">
            ...
            <Link href="/owners/dashboard" className="btn btn-outline-secondary">
              Back to Dashboard
            </Link>
          </div>
        </Col>
                ...
                <Card className="student-card h-100">
                  <Card.Body>
                    ...
                    <Card.Text className="text-muted mb-3">
                      ...
                      <br />
                      <strong>Budget:</strong> €{student.minBudget} - €{student.maxBudget}/month
                      <br />
                      <strong>Preferred Area:</strong> {student.area}
                      <br />
                      <strong>Move-in Date:</strong> {new Date(student.moveInDate).toLocaleDateString()}
                      <br />
                      <strong>Duration:</strong> {student.duration}
                      <br />
                      <strong>Room Preference:</strong> {student.roomPreference}
                      <br />
                      {student.hasRoommates && (
                    ...
                    {/* OVDE JE IZMENA: Link umesto Button-a sa onClick */}
                    <Link href={`/owners/students/${student.id}`} passHref>

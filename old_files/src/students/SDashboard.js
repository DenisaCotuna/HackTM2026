...
function SDashboard() {
    ...
    const [userName, setUserName] = useState('John Doe'); // Replace with actual user name from context or props
    ...
    const handlePostNew = () => {
        // Handle post new request logic here
                        ...
                        <Col md={4} key={request.id} className="mb-4">
                            <Card>
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        <strong>Budget:</strong> {request.budget}<br />
                                        <strong>Move-in Date:</strong> {request.moveInDate}<br />
                                ...
                                <Col md={4} key={match.id} className="mb-4">
                                    <Card>
                                        ...
                                        <Card.Body>
                                            ...
                                            <Card.Text>
                                                <strong>Price:</strong> {match.price}<br />

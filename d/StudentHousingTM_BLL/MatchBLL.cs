...
namespace StudentHousingTM.BLL
{
    public class MatchBLL
    {
        ...
        {
            return MatchDAL.InsertMatch(studentRequestID, propertyID, matchScore, matchType);
        }

        public static int SetStudentInterested(int matchID, bool interested)
        {
            return MatchDAL.SetStudentInterested(matchID, interested);
        }

        public static int SetOwnerInterested(int matchID, bool interested)
        {
            return MatchDAL.SetOwnerInterested(matchID, interested);
        }

        public static int Reject(int matchID, string rejectedBy)
        {

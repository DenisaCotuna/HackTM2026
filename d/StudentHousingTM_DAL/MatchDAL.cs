...
namespace StudentHousingTM_DAL
{
    public static class MatchDAL
    {
        ...
        public static int InsertMatch(int studentRequestID, int propertyID,
            int matchScore, string matchType)
        {
            ...
            object result = DBHelper.ExecuteScalar("usp_InsertMatch", parameters);
        ...
        public static int SetStudentInterested(int matchID, bool interested)
        {
            ...
            return DBHelper.ExecuteNonQuery("usp_SetStudentInterested", parameters);
        }
        ...
        public static int SetOwnerInterested(int matchID, bool interested)
        {
            ...
            return DBHelper.ExecuteNonQuery("usp_SetOwnerInterested", parameters);
        }

        // Rejects a match
        public static int RejectMatch(int matchID, string rejectedBy)
        {
            SqlParameter[] parameters = {
                new SqlParameter("@MatchID",    matchID),
